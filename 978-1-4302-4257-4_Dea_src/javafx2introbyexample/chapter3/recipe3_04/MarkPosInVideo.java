package javafx2introbyexample.chapter3.recipe3_04;
...
public class MarkPosInVideo extends Application {
    ...
    public void start(final Stage primaryStage) {
        primaryStage.setTitle("Chapter 3-4 Mark Position in Video");
            ...
            public void handle(DragEvent event) {
                ...
                mediaPlayer.setOnMarker(new EventHandler<MediaMarkerEvent> (){
                    public void handle(MediaMarkerEvent event){
                        ...
                        System.out.println(event.getMarker().getKey() + " duration: " + event.getMarker().getValue());
